...
![](/01-linux/images/fundamentals/ssh-port-1.png)
...
![](/01-linux/images/fundamentals/ssh-port-2.png)
...
![](/01-linux/images/fundamentals/ssh-port-3.png)
...
![](/01-linux/images/fundamentals/ssh-port-4.png)
...
![](/01-linux/images/fundamentals/ssh-port-5.png)
...
![](/01-linux/images/fundamentals/ssh-port-6.png)
...
![](/01-linux/images/fundamentals/ssh-config-1.png )
![](/01-linux/images/fundamentals/ssh-config-2.png )

### Tắt log đăng nhập lần cuối
Thực hiện sửa đổi ở dòng `106` , đồng thời bỏ dấu “#” ở đầu dòng :
![](/01-linux/images/fundamentals/ssh-config-3.png )
...
![](/01-linux/images/fundamentals/ssh-config-4.png )
