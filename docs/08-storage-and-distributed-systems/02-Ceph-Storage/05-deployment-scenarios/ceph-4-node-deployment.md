...
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/ceph 4-node cluster.png)
...
# Thiết kế mạng
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/ceph 4-node cluster - network.png)
...
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/hostname-setup.png)
...
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/disable-cloud-init.png)
...
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/remove-cloud-init-setup.png)

Tạo cấu hình Netplan mới
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/check-network-address.png)
...
sudo netplan apply
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/approved-config.png)
...
ping -c2 ceph-node0
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/node-to-node-ping.png)
...
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/disk-added-check.png)
...
sudo ufw status verbose
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/firewall-setup.png)


### Đồng bộ thời gian 
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/time-sync.png)
...
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/keyless-root-check.png)
...
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/ceph-bootstrap.png)
...
ceph mon stat
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/MON-added.png)
...
ceph mgr module ls
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/MGR-added.png)
...
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/OSD-added.png)
...
ceph orch host ls
```
![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/ceph-cluster-check.png)

![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/ceph-dashboard-1.png)

![](/08-storage-and-distributed-systems/02-Ceph-Storage/images/deployment/ceph 4-node cluster/ceph-dashboard-2.png)
