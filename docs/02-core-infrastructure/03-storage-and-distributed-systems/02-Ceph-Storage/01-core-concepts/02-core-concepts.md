...
# Replication (moved)
Xem mục "## Cơ chế Replication" ở phần **Tổng quan** cho nội dung đã hợp nhất.
...
![](/08/storage-and-distributed-systems/02-Ceph-Storage/images/theory/rebalancing.jpg)
...
![](/08/storage-and-distributed-systems/02-Ceph-Storage/images/theory/backfill-1.webp)  <=>  ![](/08/storage-and-distributed-systems/02-Ceph-Storage/images/theory/backfill-2.webp)
...
![](/08/storage-and-distributed-systems/02-Ceph-Storage/images/theory/backfill-async-server.webp)
