...
Nếu nhiều packet có destination MAC khác MAC của `br-ex`, chúng có thể chỉ là broadcast/flooded/unknown traffic bị đưa tới local interface rồi bị kernel drop.
