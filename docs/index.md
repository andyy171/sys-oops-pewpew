# Learning Corner Docs

Kho ghi chú này là bản đồ học và vận hành cho System Engineering, Cloud, DevOps, SRE, Security, Linux, Networking, Kubernetes, OpenStack, Ceph, observability, CI/CD và automation.
...
- [Kafka](./03-compute-and-orchestration/06-messaging-and-streaming/01-kafka/01-core-concepts/architecture.md)
...
- [OpenStack](./04-cloud-edge/02-cloud-ecosystem/openstack/overview.md)
- [Azure](./04-cloud-edge/02-cloud-ecosystem/azure/overview.md)
- [Huawei Cloud](./04-cloud-edge/02-cloud-ecosystem/huawei%20cloud/huawei_cloud_overview.md)
...
- [Cross-Language Patterns](./06-programming-languages/90-cross-language-patterns/overview.md)

## 7. Exam Tracks

- [CCNA Fundamentals And Protocols](./02-core-infrastructure/02-network/05-ccna-fundamentals-and-protocols/overview.md)
