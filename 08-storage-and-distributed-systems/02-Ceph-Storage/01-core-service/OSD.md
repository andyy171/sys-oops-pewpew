...
- [Kiến trúc và cơ chế hoạt động](#kiến-trúc-và-cơ-chế-hoạt-động)
    + [Cơ chế lưu trữ và truy xuất dữ liệu](#cơ-chế-lưu-trữ-và-truy-xuất-dữ-liệu)
    + [Replication và High Availability](#replication-và-high-availability)
    + [Khôi phục tự động](#khôi-phục-tự-động)
- [Cấu hình OSD](#cấu-hình-osd)
    + [Tỷ lệ OSD trên Physical Hardware](#tỷ-lệ-osd-trên-physical-hardware)
        * [Lưu ý về RAID](#lưu-ý-về-raid)
- [Filesystem cho Ceph OSD](#filesystem-cho-ceph-osd)
    + [Vai trò của Linux Filesystem](#vai-trò-của-linux-filesystem)
    + [So sánh các Filesystem](#so-sánh-các-filesystem)
        * [Btrfs (B-tree File System)](#btrfs-b-tree-file-system)
        * [xfs (XFS File System)](#xfs)
        * [ext4 (Ext4 File System)](#ext4-fourth-extended-filesystem)
    + [XATTRs (Extended Attributes)](#extended-attributes-xattrs)
- [Ceph OSD Journal](#ceph-osd-journal)
    + [Cơ chế hoạt động](#cơ-chế-hoạt-động)
    + [Tối ưu với SSD Journal](#tối-ưu-với-ssd-journal)
    + [Bảo vệ dữ liệu với Journal](#bảo-vệ-dữ-liệu-với-journal)
    + [Best Practices](#best-practices)
- [PG (Placement Group)](#pg-placement-group)
---
