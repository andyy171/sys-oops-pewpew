...
- [Mục lục](#mục-lục)
- [Tổng quan](#tổng-quan)
- [Cách pool hoạt động](#cách-pool-hoạt-động)
- [Các loại pools](#các-loại-pools)
  - [Replicated Pools](#replicated-pools)
  - [Erasure-coded Pools](#erasure-coded-pools)
- [Pool creation \& configuration](#pool-creation--configuration)
- [Pool-level settings (size, min\_size, pg\_num)](#pool-level-settings-size-min_size-pg_num)
- [Pool quotas](#pool-quotas)
  - [Quota usecase](#quota-usecase)
- [Application tags](#application-tags)
  - [Enable application tag](#enable-application-tag)
  - [Kiểm tra application tags](#kiểm-tra-application-tags)
  - [Health warning nếu thiếu tag](#health-warning-nếu-thiếu-tag)
  - [Fix warning](#fix-warning)
  - [Custom application names](#custom-application-names)
  - [Application metadata (Advanced)](#application-metadata-advanced)
